...
- **Global scope**: `C:/Users/KIIT0001/Documents/antigravity skills/AI Customer Support Agent for Commerce/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/KIIT0001/Documents/antigravity skills/AI Customer Support Agent for Commerce/.opencode/notes/`)
...
2. Glob `C:/Users/KIIT0001/Documents/antigravity skills/AI Customer Support Agent for Commerce/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/KIIT0001/Documents/antigravity skills/AI Customer Support Agent for Commerce/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/KIIT0001/Documents/antigravity skills/AI Customer Support Agent for Commerce/.opencode/notes/` — works in any directory
