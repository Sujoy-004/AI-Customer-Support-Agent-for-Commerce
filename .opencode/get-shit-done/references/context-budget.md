...
The keys live in `.claude/settings.json` (project) or `C:/Users/KIIT0001/Documents/antigravity skills/AI Customer Support Agent for Commerce/.opencode/settings.json` (global) — **not** in `.planning/config.json`:
