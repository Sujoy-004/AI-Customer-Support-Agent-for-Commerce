...
- [ ] **Phase 2: Policy Grounding & Guardrails** - Agent restricted to store policies and actively refusing off-topic prompts
- [ ] **Phase 3: Live Catalog Intelligence** - Real-time Shopify queries for catalog, sizing, and stock without hallucinations
